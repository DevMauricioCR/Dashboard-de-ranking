  ...
  return (
    <div className="panel">
          ...
          {podOrder.map((a, i) => a && (
            <div key={a.ownerId} className={`pod ${podClass[i]}`}>
              ...
              <div className="pod-bar">
                <AnimBar
                  target={Math.round(a.totalVentas / max * 100)}
                  delay={i * 80}
      ...
      <div className="rrow hdr">
        ...
        <div className="col-hdr">Participación</div>
      </div>

      {resto.map((a, i) => {
        const pct = Math.round(a.totalVentas / max * 100)
          ...
          <div key={a.ownerId}>
            ...
            >
              ...
              <div className="rav">
                ...
                <span className="rname">{a.nombre}</span>
              </div>
